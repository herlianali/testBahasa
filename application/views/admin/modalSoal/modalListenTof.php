<div class="modal fade" id="LTofle" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url().'admin/storeL'; ?>" method="POST">
            <div class="row">
              <div class="col-md-6">
